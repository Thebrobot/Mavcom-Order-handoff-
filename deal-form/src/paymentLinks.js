...
export const PAYMENT_LINK_CATEGORIES = [
  {
    ...
    label: "Brobot One Basic + Devices",
    links: [
      {
        id: "basic-dev-1",
        shortLabel: "1 Device",
        label: "Brobot One Basic + Devices (1 Device)",
        priceUsd: 152,
        url: "https://buy.stripe.com/4gM6oI8Z6g9587V5jx6sw2h",
      },
      {
        id: "basic-dev-2",
        shortLabel: "2 Devices",
        label: "Brobot One Basic + Devices (2 Devices)",
        priceUsd: 168,
      ...
      },
      {
        ...
        label: "Brobot One Basic + Devices (3 Devices)",
        priceUsd: 183,
      ...
      },
      {
        ...
        label: "Brobot One Basic + Devices (4 Devices)",
        priceUsd: 199,
      ...
      },
      {
        ...
        label: "Brobot One Basic + Devices (5 Devices)",
        priceUsd: 214,
      ...
      },
      {
        ...
        label: "Brobot One Basic + Devices (6 Devices)",
        priceUsd: 230,
      ...
      },
      {
        ...
        label: "Brobot One Basic + Devices (7 Devices)",
        priceUsd: 246,
  ...
  {
    id: "one-core-devices",
    label: "Brobot One Core + Devices",
    links: [
      {
        id: "core-dev-6",
        shortLabel: "6 Devices",
        label: "Brobot One Core + Devices (6 Devices)",
        priceUsd: 465,
      ...
      },
      {
        id: "core-dev-5",
        shortLabel: "5 Devices",
        label: "Brobot One Core + Devices (5 Devices)",
        priceUsd: 439,
      ...
      },
      {
        id: "core-dev-4",
        shortLabel: "4 Devices",
        label: "Brobot One Core + Devices (4 Devices)",
        priceUsd: 413,
      ...
      },
      {
        id: "core-dev-3",
        shortLabel: "3 Devices",
        label: "Brobot One Core + Devices (3 Devices)",
        priceUsd: 387,
      ...
      },
      {
        id: "core-dev-2",
        shortLabel: "2 Devices",
        label: "Brobot One Core + Devices (2 Devices)",
        priceUsd: 361,
      ...
      },
      {
        id: "core-dev-1",
        shortLabel: "1 Device",
        label: "Brobot One Core + Devices (1 Device)",
        priceUsd: 335,
  ...
  },
  {
    ...
    label: "Agent Broski (AI Voice)",
    links: [
      {
        id: "aire-6",
        shortLabel: "6 Devices",
        label: "Agent Broski (AI Voice) (6 Devices)",
        priceUsd: 982,
      ...
      },
      {
        id: "aire-5",
        shortLabel: "5 Devices",
        label: "Agent Broski (AI Voice) (5 Devices)",
        priceUsd: 956,
      ...
      },
      {
        id: "aire-4",
        shortLabel: "4 Devices",
        label: "Agent Broski (AI Voice) (4 Devices)",
        priceUsd: 930,
      ...
      },
      {
        id: "aire-3",
        shortLabel: "3 Devices",
        label: "Agent Broski (AI Voice) (3 Devices)",
        priceUsd: 904,
      ...
      },
      {
        id: "aire-2",
        shortLabel: "2 Devices",
        label: "Agent Broski (AI Voice) (2 Devices)",
        priceUsd: 878,
      ...
      },
      {
        id: "aire-1",
        shortLabel: "1 Device",
        label: "Agent Broski (AI Voice) (1 Device)",
        priceUsd: 852,
  ...
  {
    id: "one-core-broski",
    label: "Agent Broski (AI Voice and SMS)",
    links: [
      {
        id: "broski-6",
        shortLabel: "6 Devices",
        label: "Agent Broski (AI Voice and SMS) (6 Devices)",
        priceUsd: 1172,
      ...
      },
      {
        id: "broski-5",
        shortLabel: "5 Devices",
        label: "Agent Broski (AI Voice and SMS) (5 Devices)",
        priceUsd: 1146,
      ...
      },
      {
        id: "broski-4",
        shortLabel: "4 Devices",
        label: "Agent Broski (AI Voice and SMS) (4 Devices)",
        priceUsd: 1120,
      ...
      },
      {
        id: "broski-3",
        shortLabel: "3 Devices",
        label: "Agent Broski (AI Voice and SMS) (3 Device)",
        priceUsd: 1094,
        url: "https://buy.stripe.com/afa00k8Z6iffAn27l6sw27",
      },
      {
        id: "broski-2",
        shortLabel: "2 Devices",
        label: "Agent Broski (AI Voice and SMS) (2 device)",
        priceUsd: 1068,
      ...
      },
      {
        id: "broski-1",
        shortLabel: "1 Device",
        label: "Agent Broski (AI Voice and SMS) (1 device)",
        priceUsd: 1042,
