...
export const PAYMENT_LINK_CATEGORIES = [
  ...
  {
    id: "one-core-broski",
    label: "Agent Broski Ai Receptionist + Conversational AI (SMS)",
    links: [
      {
        id: "broski-1",
        shortLabel: "1 Device",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (1 Device)",
        priceUsd: 1042,
      ...
      },
      {
        id: "broski-2",
        shortLabel: "2 Devices",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (2 Devices)",
        priceUsd: 1068,
      ...
      },
      {
        id: "broski-3",
        shortLabel: "3 Devices",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (3 Devices)",
        priceUsd: 1094,
      ...
      },
      {
        id: "broski-4",
        shortLabel: "4 Devices",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (4 Devices)",
        priceUsd: 1120,
      ...
      },
      {
        id: "broski-5",
        shortLabel: "5 Devices",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (5 Devices)",
        priceUsd: 1146,
      ...
      },
      {
        id: "broski-6",
        shortLabel: "6 Devices",
        label: "Agent Broski Ai Receptionist + Conversational AI (SMS) (6 Devices)",
        priceUsd: 1172,
